...
func TestParseEntryExtractsNodeMetadata(t *testing.T) {
	...
	entry := &zeroconf.ServiceEntry{
		ServiceRecord: zeroconf.ServiceRecord{Instance: "strom-node-1234"},
	...
	if node.ID != "serial-1234" || node.Instance != "strom-node-1234" || node.Address != "192.168.1.50" || node.UPSCount != 2 {
